...
class Config:
    ...
    def __init__(self) -> None:
        self.telegramy_ws_url = os.environ.get("RELAYPI_WS_URL", DEFAULT_WS_URL)
        self.telegramy_mcp_url = os.environ.get("RELAYPI_MCP_URL", DEFAULT_MCP_URL)
        ...
        self.project_dir = os.environ.get("RELAYPI_PROJECT_DIR", DEFAULT_PROJECT_DIR)
        self.session_dir = os.environ.get("RELAYPI_SESSION_DIR", DEFAULT_SESSION_DIR)
        self.allowlist_path = os.environ.get("RELAYPI_ALLOWLIST", DEFAULT_ALLOWLIST)
